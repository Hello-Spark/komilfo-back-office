...
import {
  ...
  initials,
  useCurrentProfile,
} from "@/lib/supabase/useCurrentProfile";
...
export default function UserDropdown() {
  ...
  const roleLabel =
    profile?.role === "admin" ? "Admin" : profile ? "Employé Magasin" : "";
    ...
    <div className="relative">
      ...
      >
        <div>
          ...
          {roleLabel && (
            <span className="mt-1 inline-flex items-center rounded-full bg-brand-50 px-2 py-0.5 text-xs font-medium text-brand-700 dark:bg-brand-500/15 dark:text-brand-300">
              {roleLabel}
            </span>
          )}
        </div>
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M12 2.25a.75.75 0 0 1 .28.054l7.25 2.9A.75.75 0 0 1 20 5.9v5.6c0 4.28-2.79 8.12-6.87 9.47l-.9.3a.75.75 0 0 1-.46 0l-.9-.3C6.79 19.62 4 15.78 4 11.5V5.9a.75.75 0 0 1 .47-.697l7.25-2.9A.75.75 0 0 1 12 2.25Zm0 1.558L5.5 6.41V11.5c0 3.64 2.37 6.91 5.84 8.05l.66.22.66-.22c3.47-1.14 5.84-4.41 5.84-8.05V6.41L12 3.808Zm3.28 5.662a.75.75 0 0 1 0 1.06l-4 4a.75.75 0 0 1-1.06 0l-2-2a.75.75 0 1 1 1.06-1.06l1.47 1.47 3.47-3.47a.75.75 0 0 1 1.06 0Z"
                  fill=""
                />
              </svg>
              Sécurité
