        ...
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <div className="hidden lg:block">
            <button
              ...
              className="dark:bg-dark-900 relative flex h-11 w-full items-center gap-3 rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-left text-sm text-gray-400 shadow-theme-xs hover:border-gray-300 hover:text-gray-600 dark:border-gray-800 dark:bg-gray-900 dark:bg-white/[0.03] dark:text-white/40 dark:hover:border-gray-700 dark:hover:text-gray-300 xl:w-[430px]"
            >
              ...
              <span className="flex-1">Rechercher un lead ou une commande…</span>
